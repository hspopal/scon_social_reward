...
#set below wd for PC
#setwd("U:/redcay/DSCN Lab/Experiments/SCONN/Social Reward fMRI answers/Pre and post data")
...
#set below path for PC
#write.csv(combine,'U:/redcay/DSCN Lab/Experiments/SCONN/Social Reward fMRI answers/Pre and post data/correctorder.csv', row.names = FALSE)
