...
indir=/data/bswift-1/${uname}/SCN/fmriprep
[ ! -d $indir ] && mkdir $indir
...
#
/data/bswift-0/software/singularity/bin/singularity run --cleanenv \
--home /data/bswift-1/${uname}:/home/${uname} \
/data/bswift-1/hpopal/fmriprep-20.2.6.simg \
/home/${uname}/SCN/fmriprep/BIDS /home/${uname}/SCN/fmriprep/out participant \
--participant-label ${Sub} \
--skull-strip-template MNI152NLin2009cAsym --output-spaces MNIPediatricAsym:cohort-5:res-2 anat \
--use-aroma \
--nthreads 8 --n_cpus 6 --omp-nthreads 6 \
--mem-mb 24000 \
--skip_bids_validation \
--no-submm-recon \
--fs-license-file /home/${uname}/license.txt
#
echo "------------------------------------------------------------------"
echo "Ended fMRIprep"
echo ${Sub}
