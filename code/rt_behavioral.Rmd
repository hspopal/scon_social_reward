...
```{r}
model_run_peer_typ <- lmer(Correct_RT_logz ~ Run*Condition + age + (1 + Run*Condition | participant_id),
                       data = rt_data_mod_typ)
...
```{r}
model_run_peer_asd <- lmer(Correct_RT_logz ~ Run*Condition + (1 + Run*Condition | participant_id), data = rt_data_mod_asd)
